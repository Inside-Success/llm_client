...
2. Role config (`duet.py`): `DuetRoles` Pydantic model with defaults `plan=codex/gpt-5-codex`, `plan_review=claude-code/opus`, `implement=codex/gpt-5-codex`, `implement_review=claude-code/opus`. Caller can override per stage.
