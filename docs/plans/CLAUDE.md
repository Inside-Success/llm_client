...
| 99 | [Strict native JSON-schema execution](99_strict_native_json_schema_execution.md) | High | 🚧 In Progress (second repair rejected; third repair active) | onto-canon6 Plan 0141 R2 runtime authorization |
