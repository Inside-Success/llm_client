...
|---|------|----------|--------|--------|
| 106 | [Direct GPT-5.5 Structured Capability Truth](106_gpt55_structured_capability_truth.md) | High | ✅ Complete | Prevent unsupported direct GPT-5.5 JSON-schema dispatch |
