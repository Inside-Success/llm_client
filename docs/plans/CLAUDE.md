...
| 99 | [Strict native JSON-schema execution](99_strict_native_json_schema_execution.md) | High | 🚧 In Progress (second repair locally green; independent acceptance pending) | onto-canon6 Plan 0141 R2 runtime authorization |
