...
|---|------|----------|--------|--------|
| 121 | [Privacy-Bounded Attempt Diagnostic Envelope](121_attempt_diagnostic_envelope.md) | Critical | 📋 Planned | Evidence-based failure localization and provider-attribution claims |
