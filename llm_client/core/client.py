...
from llm_client.utils.litellm_log_filters import (  # noqa: E402
...
def call_llm_structured(
    ...
    **kwargs: Any,
    ...
    if resolved_timeout is None:
        ...
        resolved_timeout = 0 if _timeouts_disabled() else _default_timeout_for_caller(caller="call_llm_structured")
    envelope = _prepare_public_call_envelope(
...
async def acall_llm_structured(
    ...
    **kwargs: Any,
    ...
    if resolved_timeout is None:
        ...
        # call_llm_structured).
        resolved_timeout = 0 if _timeouts_disabled() else _default_timeout_for_caller(caller="acall_llm_structured")
    envelope = _prepare_public_call_envelope(
