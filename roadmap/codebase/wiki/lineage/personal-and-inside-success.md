...
created: 2026-08-16
updated: 2026-08-16
sources: [../../../../docs/plans/105_inside_success_fork_reconciliation.md, ../sources/revision-f194028.md]
confidence: high
---
...
The current source manifest binds only to the personal upstream at `f194028`.
...
See [Revision f194028 source ingest](../sources/revision-f194028.md) for the
current binding and [Architecture](../architecture.md) for code relationships.

# Citations

1. [Plan 105 reconciliation authority at `f194028`](https://github.com/BrianMills2718/llm_client/blob/f194028cec906fac8f3e3eef48ad30d84e8cf5bb/docs/plans/105_inside_success_fork_reconciliation.md)
2. [Personal source revision on GitHub](https://github.com/BrianMills2718/llm_client/tree/f194028cec906fac8f3e3eef48ad30d84e8cf5bb)
